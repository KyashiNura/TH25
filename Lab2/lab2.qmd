...
4.  Сколько уникальных рас персонажей (species) представлено в данных? 38

    ```{r}
    starwars %>% pull(species) %>% unique() %>% length()
    ```

5.  Найти самого высокого персонажа: Yarael
...
10. Найти самый распространенный цвет глаз персонажей вселенной Звездных войн: brown
